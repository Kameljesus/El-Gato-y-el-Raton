...
def movimiento_disponibles_gato(tablero, x1, y1):
    ...
    for nueva_x, nueva_y in direcciones:
        x1 = x1 + nueva_x
        y1 = y1 + nueva_y

        if x1 < 14 or x1 >= 0 or y1 < 24 or y1 >+ 0:
            movimientos_gato.append(x1, y1)
...
# El Minimax necesita:
    ...
    # Dos objetos (Dos jugadores u objetivos).
    # Una meta.

# Definirle los movimientos.

# Definir las condiciones de estos movimientos.

# Mostrarle los movimientos posibles.
