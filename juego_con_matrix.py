...
tablero = [["." for columna in range(13)] for fila in range(7)]
...
def evaluar_gato(tablero, posicion_gato):
    ...
    if posicion_raton is None:
        return 1000  # El gato ya ganó (el ratón no está en el tablero)
...
while True:
    ...
    turno_raton()
    gato_sigue_en_juego = any('G' in fila for fila in tablero)
    print("")
